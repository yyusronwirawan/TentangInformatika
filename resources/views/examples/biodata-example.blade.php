                ...
                <div class="table-1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="colon">:</td>
                            <td class="body ">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis rerum iusto,
                                necessitatibus molestias odit quam!
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="colon">:</td>
                            <td class="body ">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate aut aspernatur
                                ipsum cumque nisi. Blanditiis ratione velit laboriosam iure, eum minus optio architecto
                                incidunt aut consequuntur sapiente dolorum ut necessitatibus.
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="table-2">
                    <table>
                        <tr>
                            <th class="image">
                                <img class="profile"
                                    src="{{ asset('/storage/image/profile-picture/photo-by-anjas12001-68406.jpg') }}"
                                    alt="profile picture" style="width: 150px">
                            </th>
                            <td class="sign-mark">
                                <p>Parepare, 24 Agustus 2023</p>
                                <p>Calon Peserta,</p>
                                <br><br><br><br>
                                <p class="name">Anjas Amiruddin</p>
                            </td>
                        </tr>
                    </table>
                </div>
