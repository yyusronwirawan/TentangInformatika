<section id="about" class="pt-20 lg:py-32 ">
    <div class="container">
        <div class="text-center">
            <h4 class="text-md font-bold mb-8 text-dark lg:text-lg dark:text-white">ABOUT US</h4>
        </div>
        <div class="flex flex-wrap">
            <div class="w-full mb-10 lg:w-1/2">
                <h3 class="text-lg font-semibold text-dark dark:text-gray-100">Halo, Kami</h3>
                <h2 class="text-2xl font-bold mb-1 text-primary lg:text-3xl">Study Club Informatika</h2>
                <p
                    class="font-medium text-secondary text-sm mb-2 max-w-lg sm:max-w-full lg:max-w-md xl:max-w-xl text-justify dark:text-gray-400">
                    Adalah Organisasi Mahasiswa Independen yang bergerak, mengkaji, dan mengembangkan keilmuan khususnya
                    di bidang Informatika. Berdiri sejak tanggal 31 Mei 2009.
                </p>
                <p
                    class="font-medium text-secondary text-sm max-w-lg sm:max-w-full lg:max-w-md xl:max-w-xl text-justify dark:text-gray-400">
                    Pada awalnya SCI merupakan Kelompok Belajar yang berada dibawah naungan Universitas Muhammadiyah
                    Parepare. Setelah menghadapi dinamika dari internal, SCI memutuskan untuk tidak lagi berada dibawah
                    naungan Universitas. Kini SCI menjadi Organisasi Eksternal Independen dan telah menghasilkan kader
                    yang kompeten dibidangnya.
                </p>
            </div>
            <div class="w-full mb-10 lg:w-1/2 sm:pt-[27px] lg:pl-4">
                <h3 class="font-bold text-xl text-dark mb-[10px] lg:text-2xl dark:text-gray-100">Mau tau lebih banyak..?
                </h3>
                <p class="font-medium text-secondary text-sm max-w-xl text-justify dark:text-gray-400">Kunjungi kami
                    dibawah ini
                    untuk
                    mengetahui lebih banyak tentang kami dan jangan ragu untuk menghubungi kami jika ada
                    pertanyaan.
                </p>
                <div class="flex items-center mt-3 gap-x-5">
                    <a href="https://www.instagram.com/studyclubinformatika/" target="_blank" rel="noopener noreferrer">
                        <div
                            class="bg-gradient-to-bl from-teal-100 via-white to-teal-100 w-12 h-12 border border-gray-300 rounded-lg shadow hover:scale-110 hover:shadow-xl transition duration-300 flex items-center justify-center dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950 dark:border-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                                class="main-grid-item-icon" fill="none">
                                <path clip-rule="evenodd"
                                    d="M12 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324ZM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z"
                                    fill="url(#instagram__a)" fill-rule="evenodd" />
                                <path d="M18.406 7.034a1.44 1.44 0 1 0 0-2.88 1.44 1.44 0 0 0 0 2.88Z"
                                ...
                                <path clip-rule="evenodd"
                                    ...
                                    fill="url(#instagram__c)" fill-rule="evenodd" />
                                <defs>
                                    <linearGradient gradientUnits="userSpaceOnUse" id="instagram__a" x1="14.101"
                                        x2="7.087" y1="-1.272" y2="21.899">
                                        <stop stop-color="#515BD4" />
                                        <stop offset=".26" stop-color="#9510B8" />
                                        <stop offset=".66" stop-color="#E51804" />
                                        <stop offset="1" stop-color="#FFBF00" />
                                    </linearGradient>
                                    <linearGradient gradientUnits="userSpaceOnUse" id="instagram__b" x1="14.101"
                                        x2="7.087" y1="-1.272" y2="21.899">
                                        <stop stop-color="#515BD4" />
                                        <stop offset=".26" stop-color="#9510B8" />
                                        <stop offset=".66" stop-color="#E51804" />
                                    ...
                                    <linearGradient gradientUnits="userSpaceOnUse" id="instagram__c" x1="14.101"
                                        x2="7.087" y1="-1.272" y2="21.899">
                                        <stop stop-color="#515BD4" />
                                        <stop offset=".26" stop-color="#9510B8" />
                                        <stop offset=".66" stop-color="#E51804" />
                    ...
                    <a href="https://www.facebook.com/studyclubinformatika.sci" target="_blank"
                    ...
                    <a href="https://www.youtube.com/@studyclubinformatika1734" target="_blank"
                        rel="noopener noreferrer">
                        <div
                            class="bg-gradient-to-bl from-teal-100 via-white to-teal-100 w-12 h-12 border border-gray-300 rounded-lg shadow hover:scale-110 hover:shadow-xl transition duration-300 flex items-center justify-center dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950  dark:border-gray-700">
