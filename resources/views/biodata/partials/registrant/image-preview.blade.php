<div class="flex justify-center">
    ...
    @else
        <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
            <div
                class="flex items-center justify-center w-52 h-64 bg-gray-300 rounded-lg md:w-48 min-[1440px]:w-40 dark:bg-gray-700">
                ...
                <img class="h-64 w-auto rounded-lg img_preview">
            </div>
